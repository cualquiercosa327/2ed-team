...
\begingroup
\color{Maroon}\spacedallcaps{Inferencia Estadística: Aplicaciones y Métodos} \\ \bigskip % Thesis title

\endgroup

\spacedlowsmallcaps{Hanwen Zhang \& Andrés Gutiérrez} % Your name
...
{\centering \includegraphics[width=0.8\linewidth]{classic_files/figure-latex/fig1-1} 
