...
\item Diseñe un estudio de simulación para comparar los intervalos (\ref{int_expo_gamma}) y (\ref{int_expo_nor}) en términos de la longitud. Muestre los resultados en una gráfica e interprete.
